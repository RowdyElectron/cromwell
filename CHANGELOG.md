...
As of Cromwell 57, a distribution of Java 11 is required to run Cromwell. Cromwell is developed, tested, and dockerized
using [AdoptOpenJDK 11 HotSpot](https://adoptopenjdk.net/).
